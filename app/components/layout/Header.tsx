...
export default function Header({ user }: HeaderProps) {
  ...
  useEffect(() => {
    ...
    const handleTouchEnd = () => {
      ...
      // Right swipe from LEFT edge (open menu from left)
      if (isRightSwipe && touchStartX < maxEdgeDistance && !mobileMenuOpen) {
        setMobileMenuOpen(true);
      }
      
      // Left swipe when menu is open (close menu)
  ...
  }, [touchStartX, touchEndX, touchStartY, touchEndY, mobileMenuOpen]);
