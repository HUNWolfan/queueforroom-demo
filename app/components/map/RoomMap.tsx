          ...
          {currentFloorRooms.map(room => {
            ...
            <g key={room.id}>
              ...
              <text
                ...
                y={room.position_y + room.height / 2 - 10}
                textAnchor="middle"
              ...
              <text
                x={room.position_x + room.width / 2}
                y={room.position_y + room.height / 2 + 15}
                textAnchor="middle"
                dominantBaseline="middle"
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
              <h3 style={{ margin: 0, color: 'var(--text-primary)' }}>{getRoomName(selectedRoom)}</h3>
              <button 
                onClick={() => setSelectedRoom(null)}
                style={{
                  background: 'none',
            ...
            <div style={{ color: 'var(--text-primary)', marginBottom: '1.5rem' }}>
